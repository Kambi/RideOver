...
public class MainFragment extends Fragment implements View.OnClickListener{
    ...
    private static Button getRide;
    private static Button shareRide;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //final Button mainButton = (Button) HomeScreenNav.findViewById(R.id.);
    ...
    /*public void setInterface(View interface2){
    ...
    /*public void OnClick(){
        Log.d("Fragment", "Clicked get a ride");
        getRide = (Button)(getView().findViewById((R.id.get_ride_nav)));
    ...
    /*public void OnClickShareARide(){
        ...
        shareRide = (Button)(getView().findViewById(R.id.share_ride_nav));
